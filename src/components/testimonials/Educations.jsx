    ...
    <section id='educations'>
      ...
      >
        <SwiperSlide key={1} className='education'>
          ...
          <small className='education__name'>CPI: 7.63 (till current SEM)</small>
        </SwiperSlide>
        <SwiperSlide key={2} className='education'>
          <div className="education__avatar">
            <img src={boards} alt="12TH Boards" />
          </div>
          <h5 className='education__name'>(12th )</h5>
          <small className='education__review'>Jawahar Navodaya Vidyalaya</small>
          <small className='education__name'>84.6%</small>
        </SwiperSlide>
        <SwiperSlide key={3} className='education'>
          <div className="education__avatar">
            <img src={boards} alt="10TH Boards" />
          </div>
          <h5 className='education__name'> (10th )</h5>
          <small className='education__review'>Jawahar Navodaya Vidyalaya</small>
          <small className='education__name'>89.3%</small>
        </SwiperSlide>
      </Swiper>
    </section>
  )
