...
import './about.css'
import ME from '../../assets/me1-about.jpeg'
        ...
        <div className="about__content">
          <div className="about__cards">
            <article className='about__card'>
              ...
              <h5>Leetcode</h5>
              <a href="https://leetcode.com/keshrishipranshi/" target="_blank">Link</a>
            </article>
            {/* <article className='about__card'>
            ...
            <article className='about__card'>
              ...
              <h5>Codechef</h5>
              <a href="https://www.codechef.com/users/keshipranshi" target="_blank">Link</a>
            </article>
            <article className='about__card'>
              <FaGithub className='about__icon' />
              <h5>Github</h5>
              <a href="https://github.com/shipranshi" target="_blank">Link</a>
            </article>
          </div>
